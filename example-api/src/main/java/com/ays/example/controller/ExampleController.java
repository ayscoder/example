...
public class ExampleController {
    ...
    public ResponseEntity<ApiResponse<ExampleDto>> createExample(@RequestHeader(value = Constant.REQUEST_ID) String requestId,
        ...
        Example exampleId = exampleService.createExample(requestId, dto);
        dto.setId(exampleId.getId());
        return toResponseEntity(new ApiResponse.Builder<ExampleDto>(HttpStatus.OK, requestId,
                EXAMPLE_SAVED.getCode(), EXAMPLE_SAVED.getReason(), EXAMPLE_SAVED.getMessage()).withData(dto).build());
    }
    ...
    @GetMapping(value = "/{id}")
    public ResponseEntity<ApiResponse<ExampleDto>> findAllExample(@RequestHeader(value = Constant.REQUEST_ID) String requestId,
    ...
    public ResponseEntity<ApiResponse<Void>> updateExample(@RequestHeader(value = Constant.REQUEST_ID) String requestId,
            @RequestBody ExampleDto exampleDto, @PathVariable String id) {
    ...
    public ResponseEntity<ApiResponse<Void>> deleteExample(@RequestHeader(value = Constant.REQUEST_ID) String requestId,
